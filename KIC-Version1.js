      ...
      let KIC_31 = {
        ...
        mainJs: function () {
          ...
          const products = [
            ...
            const injectProduct=(products)=>{
                const product=products[0];
                  const products_data=`<section class="products_wrapper">
                      <a href="${product.navigate_link}">
          ...
          const products_data = injectProduct(products)
          //random-id generate
          ...
          let random_stl = selectedIds.slice(0, 8);
          
          const product_one = products.filter(product=>{
              return product.id == random_stl[0];
          })
          const product_two = products.filter(product=>{
              return product.id == random_stl[1];
          })	
          const product_three = products.filter(product=>{
              return product.id == random_stl[2];
          })
          const product_four = products.filter(product=>{
              return product.id == random_stl[3];
          })
          const product_five = products.filter(product=>{
              return product.id == random_stl[4];
          })
          const product_six = products.filter(product=>{
              return product.id == random_stl[5];
          })
          const product_seven = products.filter(product=>{
              return product.id == random_stl[6];
          })
          const product_eight = products.filter(product=>{
              return product.id == random_stl[7];
          })
          ...
          product_tile.forEach(e => {
              i++;
              if(i===9){
                  e.insertAdjacentHTML("afterend", injectProduct(product_one));
                  e.nextSibling.classList.add("product_group_two");
              }
             else if(i===10){
                  e.insertAdjacentHTML("afterend",injectProduct(product_two));
                  e.nextSibling.classList.add("product_group_common");
              }
              else if(i===12){
                  e.insertAdjacentHTML("afterend",injectProduct(product_three));
                  e.nextSibling.classList.add("product_group_three");
              }
              else if(i===29){
                  e.insertAdjacentHTML("afterend",injectProduct(product_four));
                  e.nextSibling.classList.add('product_group_two')
              }
              else if(i===32){
                  e.insertAdjacentHTML("afterend",injectProduct(product_five));
                  e.nextSibling.classList.add("product_group_three");
              }
              else if(i===34){
                  e.insertAdjacentHTML("afterend",injectProduct(product_six));
                  e.nextSibling.classList.add("product_group_one");
              }
              else if(i===41){
                  e.insertAdjacentHTML("afterend",injectProduct(product_seven));
                  e.nextSibling.classList.add("product_group_four");
              }
              else if(i===47){
                  e.insertAdjacentHTML("afterend",injectProduct(product_eight));
                  e.nextSibling.classList.add('product_group_two')
              }
          })
        },
...
.KIC_31 .product_group_common, .KIC_31 .product_group_one{
	display: grid;
}
.KIC_31 .product_group_two, .KIC_31 .product_group_three, .KIC_31 .product_group_four{
	display: none;
}
...
@media only screen and (min-width: 769px) and (max-width: 999px){
	.KIC_31 .product_group_two{
		display: grid;
	}
	 .KIC_31 .product_group_one,.KIC_31 .product_group_three, .KIC_31 .product_group_four,.KIC_31 .product_group_common{
	 	display: none;
	 }
}
@media only screen and (min-width: 1000px) and (max-width: 1499px){
	.KIC_31 .product_group_three{
		display: grid;
	}
	 .KIC_31 .product_group_one,.KIC_31 .product_group_two,.KIC_31 .product_group_four,.KIC_31 .product_group_common{
	 	display: none;
	 }
}
@media only screen and (min-width: 1500px){
	.KIC_31 .product_group_common,.KIC_31 .product_group_four{
		display: grid;
	}
	.KIC_31 .product_group_one,.KIC_31 .product_group_two,.KIC_31 .product_group_three{
		display: none;
	}
