...
//               document.querySelector('.item1').innerHTML = item;
//               document.querySelector('.item3').innerHTML = item2;
//           }
          
//           document.querySelectorAll('li.product').forEach(elm =>{
//               elm.addEventListener("click", (event) => {
//                   if(elm.classList.contains('product_one')){
//                       document.querySelector('.js-qty__num[name="quantity"]').value = data-att;
//                       multiplyInitial(item1,item3, 1);
//                   }
//                   else if(elm.classList.contains('product_two')){
//                       document.querySelector('.js-qty__num[name="quantity"]').value = data-att;
//                       multiplyInitial(item1,item3, 2);
//                   }
//                   else if(elm.classList.contains('product_three')){
//                       document.querySelector('.js-qty__num[name="quantity"]').value = data-att;
//                       multiplyInitial(item1,item3, 3);
//                   }
//                   else if(elm.classList.contains('product_four')){
//                       document.querySelector('.js-qty__num[name="quantity"]').value = data-att;
//                       multiplyInitial(item1,item3, 4);
//                   }
    ...
    let XBX_11 = {
      ...
      mainJs: function () {
	   ...
	   let item3 =	document.querySelector('.item3').innerText;
		...
		document.querySelectorAll('li.product').forEach((elm,idx) =>{
			idx = idx+1;
			elm.addEventListener("click", (event) => { 
				
				if(elm.classList.contains('product')){
					document.querySelector('.js-qty__num[name="quantity"]').value = elm.dataset.att;
